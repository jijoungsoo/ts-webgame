...
var arr6 = [true, 1, '3'];
/* 배열을 상수처럼 쓰고 싶다. */
var arr7 = [true, 2, '3']; // 배열을 수정하지 못하게한다.
var str2 = 'hello'; //as const를 써서 상수로 해줄수있다.
var arr8 = [true, 2, '3']; // 이것  arr7하고 동일하다 
/*
const obj ={a:'b'}
...
obj.a = '3';
var obj2 = { a: 'b', b: 3 };
var obj3 = { a: 'b' }; /*b가 없을 수도 있을때 b뒤에 ?를 붙여준다. */
var Color;
(function (Color) {
...
var a = div; /* 인터페이스 형변환 */
var b = div; /*강제로 바꾸는 방법이라 문법 오류가 발생하지 않는다. */
